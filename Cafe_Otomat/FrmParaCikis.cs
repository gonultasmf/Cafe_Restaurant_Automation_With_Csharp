...
{
    public partial class FrmParaCikis : Form
    {
        ...
        private void FrmParaCikis_Load(object sender, EventArgs e)
        {
        }
        ...
        private void btnEkle_Click(object sender, EventArgs e) // kasaya işlem ekliyoruz.
        {
            ...
            else
            {
                db.Kasa_Ekle_Database("KASA-1", DataBase.kullanici, DateTime.Now,
                        txtIslemNo.Text, comboAciklama.Text, "NAKİT", "ÇIKAN",
                        0, Convert.ToDouble(txtGirenMiktar.Text));
                this.Close();
            }
        }
